    ...
    <nav class="fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-sm shadow-sm">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="{{ route('contact') }}" class="text-primary px-3 py-2 text-sm font-medium">Contact</a>
                    </div>
                </div>
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-white border-t">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="{{ route('contact') }}" class="text-primary block px-3 py-2 text-base font-medium">Contact</a>
            </div>
        </div>
    </nav>
