...
@section('title', 'Search Results for "' . $query . '" - COCO Island Holidays')
            ...
            <div class="col-xl-8 col-lg-8">
                <div class="blog-wrapper">
                    ...
                    <div class="text-center py-5">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('blog.index') }}" class="btn">Browse All Posts</a>
                        </div>
                    </div>
                    @endforelse
