...
@section('title', $tag->name . ' - COCO Island Holidays')
            ...
            <div class="col-xl-8 col-lg-8">
                <div class="blog-wrapper">
                    ...
                    <div class="single-blog mb-50">
                        ...
                        <div class="blog-text">
                            ...
                            <div class="blog-tags mt-3">
                                ...
                                <a href="{{ route('blog.tag', $postTag->slug) }}" class="badge badge-secondary mr-2 {{ $postTag->id === $tag->id ? 'active' : '' }}">
                                    {{ $postTag->name }}
                                </a>
                                @endforeach
                            </div>
                    ...
                    <div class="text-center py-5">
                        <h3>No posts found with tag "{{ $tag->name }}"</h3>
                    ...
                    <div class="sidebar-widget mb-40">
                        ...
                        <div class="sidebar-widget-content">
                            <div class="sidebar-tags">
                                ...
                                <a href="{{ route('blog.tag', $tagItem->slug) }}" class="{{ $tagItem->id === $tag->id ? 'active' : '' }}">
                                    {{ $tagItem->name }}
                                </a>
                                @endforeach
                            </div>
