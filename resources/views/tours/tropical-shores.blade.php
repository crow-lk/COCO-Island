{{-- resources/views/tropical-shores.blade.php --}}
<!doctype html>
<html class="no-js" lang="zxx">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Tropical Shores & Golden Sunsets | COCO Island Holidays</title>
        ...
        <link rel="stylesheet" href="{{ asset('css/tropical-shores.css') }}">
        @stack('styles')
    </head>
    <body>
        <!-- pre loader -->
        ...
        <main>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="tropical-shores-hero-content text-center">
                                    <h1 class="tropical-shores-page-title sec-title">Tropical Shores &amp; Golden Sunsets</h1>
                                    <p class="mt-15 mb-0 text-white">7 Days / 6 Nights — Luxury Coastal Escape with Ocean Adventures</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="best-money-content">
                                <h1>Luxury Coastal Escape</h1>
                                <p>Feel the sun, salt, and soul of the island on a hand-curated beach holiday designed for effortless relaxation and ocean-side adventure. From Bentota and Hikkaduwa to Mirissa and Galle, this itinerary blends golden sands, river safaris, seasonal whale watching, and romantic evenings under the stars.</p>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="best-money-img w-img">
                                <img src="{{ asset('frontend/assets/img/tour/Tropicalpage.jpg') }}" alt="best-money">
            ...
            <!-- Key Highlights -->
<section class="section pt-70 pb-40 tropical-highlights">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center pt-30 pb-50">
                <h1>Key Highlights</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-4 mb-30">
                <div class="single-feature p-4 h-100 text-center">
                    <div class="mb-15">
                        <span class="icon-circle"><i class="fas fa-umbrella-beach fa-2x"></i></span>
                    </div>
                    <h4 class="mb-10">Bentota · Hikkaduwa · Mirissa</h4>
                    <p class="text-center">Stay in Sri Lanka’s most loved beach towns, each with a distinct vibe and coastline.</p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-30">
                <div class="single-feature p-4 h-100 text-center">
                    ...
                    <h4 class="mb-10">Madu River &amp; Water Sports</h4>
                    <p class="text-center">Glide through mangroves on a river safari and add jet-ski or banana boat rides.</p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-30">
                <div class="single-feature p-4 h-100 text-center">
                    <div class="mb-15">
                        <span class="icon-circle"><i class="fas fa-fish fa-2x"></i></span>
                    </div>
                    <h4 class="mb-10">Whale Watching (Seasonal)</h4>
                    <p class="text-center">Head out from Mirissa at sunrise to spot blue whales and playful dolphins.</p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-30">
                <div class="single-feature p-4 h-100 text-center">
                    <div class="mb-15">
                        <span class="icon-circle"><i class="fas fa-feather-alt fa-2x"></i></span>
                    </div>
                    <h4 class="mb-10">Galle Fort at Sunset</h4>
                    <p class="text-center">Stroll the ramparts, watch the sky blaze, and explore colonial-era lanes.</p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-30">
                <div class="single-feature p-4 h-100 text-center">
                    <div class="mb-15">
                        <span class="icon-circle"><i class="fas fa-seedling fa-2x"></i></span>
                    </div>
                    <h4 class="mb-10">Turtle Hatchery Visit</h4>
                    <p class="text-center">Learn about conservation efforts and see rescued sea turtles up close.</p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-30">
                <div class="single-feature p-4 h-100 text-center">
                    <div class="mb-15">
                        <span class="icon-circle"><i class="fas fa-spa fa-2x"></i></span>
                    </div>
                    <h4 class="mb-10">Spa, Yoga &amp; Beach Dinners</h4>
                    <p class="text-center">Unwind with optional spa/yoga and end evenings with BBQs by the sea.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12">
                <ul class="list-unstyled text-center text-white">
                    <li class="mb-4">
                         <p>Curated for honeymooners &amp; beach lovers - Enjoy a balanced rhythm of leisure and adventure with premium stays and romantic add-ons.</p>
                    </li>
                    <li class="mb-4">
                        <p>Flexible mix of activities - Customize your days—water sports, wellness, or simply sun-lounging on pristine beaches.</p>
                    </li>
                    <li class="mb-4">
                        <p>Instagram-worthy moments - Galle sunsets, Mirissa cruisers, and golden sands make picture-perfect memories.</p>
                    </li>
                    <li class="mb-4">
                        <p>Premium coastal hotels - Choose from a curated list of luxury resorts along Sri Lanka’s southern coast.</p>
                    </li>
                </ul>
            </div>
